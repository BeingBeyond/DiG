...
**Chaoyi Xu<sup>1,3</sup>, [Sipeng Zheng](https://zhengsipeng.github.io)<sup>3</sup>, [Qin Jin](https://www.jin-qin.com)<sup>2</sup>, [Zongqing Lu](https://z0ngqing.github.io)<sup>1,3†</sup>**
...
DiG integrates naturally into recent flow-matching VLA architectures, including **π0.5**, **GR00T-N1**, and **Being-H**, and improves robustness under distribution shift and long-horizon rollouts.

## News

- **[2026-07-02]**: DiG has been accepted to **ECCV 2026**.
